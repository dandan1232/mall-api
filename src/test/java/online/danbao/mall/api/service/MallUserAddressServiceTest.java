...
class MallUserAddressServiceTest {
    ...
    void saveUserAddress() {
        ...
        mallUserAddress.setUserName("亦安");
        mallUserAddress.setUserPhone("18962494510");
    ...
    void getMallUserAddressById() {
        MallUserAddress address = mallUserAddressService.getMallUserAddressById(2L);
        System.out.println(address);
    }

    @Test
    void getMyDefaultAddressByUserId() {
        MallUserAddress defaultAddress = mallUserAddressService.getMyDefaultAddressByUserId(2L);
