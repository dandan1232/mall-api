...
import online.danbao.mall.api.mapper.MallUserMapper;
import online.danbao.mall.api.mapper.MallUserTokenMapper;
import online.danbao.mall.api.service.MallUserService;
import online.danbao.mall.api.util.Md5Util;
import online.danbao.mall.api.util.NumberUtil;
import online.danbao.mall.api.util.SystemUtil;
...
public class MallUserServiceImpl implements MallUserService {
    ...
    public String register(String loginName, String password) {
        ...
        MallUser registerUser = MallUser.builder()
                ...
                .avatar("http://pic-ldd-test.oss-cn-hangzhou.aliyuncs.com/md/20210129161044.jpg")
                .build();
